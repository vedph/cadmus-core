...
public sealed class Bcp47FilterTest
{
    ...
    [Fact]
    public async Task Apply_TwoLetterCode_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_ThreeLetterCode_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_AncientLanguages_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_HistoricalLanguages_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_MixedModernAndAncient_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_MultipleCodes_Changed()
    {
        Bcp47TextFilter filter = new();
        const string text =
    ...
    [Fact]
    public async Task Apply_CustomTag_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_CustomTagWithFallback_Changed()
    {
        Bcp47TextFilter filter = new();
        filter.Configure(new Bcp47FilterOptions
        {
    ...
    [Fact]
    public async Task Apply_CustomPattern_Changed()
    {
        Bcp47TextFilter filter = new();
        filter.Configure(new Bcp47FilterOptions
        {
    ...
    [Fact]
    public async Task Apply_CaseInsensitive_Changed()
    {
        Bcp47TextFilter filter = new();
        filter.Configure(new Bcp47FilterOptions
        {
    ...
    [Fact]
    public async Task Apply_SemiticLanguages_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_AsianLanguages_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_NullText_Null()
    {
        Bcp47TextFilter filter = new();

        string? filtered = (await filter.ApplyAsync(null))?.ToString();

        Assert.Null(filtered);
    }

    [Fact]
    public async Task Apply_EmptyText_Empty()
    {
        Bcp47TextFilter filter = new();
        const string text = "";
    ...
    [Fact]
    public async Task Apply_GothicAndOtherExtinct_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_RegionSubtag_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_MultipleRegionSubtags_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_ChineseVariants_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_PortugueseVariants_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_FrenchVariants_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_CustomSubtag_Changed()
    {
        Bcp47TextFilter filter = new();
        filter.Configure(new Bcp47FilterOptions
        {
    ...
    [Fact]
    public async Task Apply_CustomSubtagWithStandardFallback_Changed()
    {
        Bcp47TextFilter filter = new();
        filter.Configure(new Bcp47FilterOptions
        {
    ...
    [Fact]
    public async Task Apply_MixedBasicAndRegionTags_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_GermanVariants_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_ExtendedCustomSubtags_Changed()
    {
        Bcp47TextFilter filter = new();
        filter.Configure(new Bcp47FilterOptions
        {
    ...
    [Fact]
    public async Task Apply_CaseInsensitiveSubtags_Changed()
    {
        Bcp47TextFilter filter = new();
    ...
    [Fact]
    public async Task Apply_UnknownRegionSubtag_Fallback()
    {
        Bcp47TextFilter filter = new();
